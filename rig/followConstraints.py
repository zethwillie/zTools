...
def followConstraintsUI():
    ...
    widgets["tgtTFBG"] = cmds.textFieldButtonGrp(l="Target Obj: ", w=300, bl="<<<", cal=[(1, "left"), (2,"left"), (3,"left")], cw=[(1, 70), (2, 180), (3, 20)])
    ...
    widgets["button"] = cmds.button(l="Create!", w=200, h=40, bgc=(.5, .8, .5), c=gather_info)

    cmds.formLayout(widgets["mainForm"], e=True, af=[
        (widgets["tgtTFBG"], "left", 100),
        (widgets["tgtTFBG"], "top", 10),
        (widgets["name1TFG"], "left", 5),
        (widgets["name1TFG"], "top", 50),
        (widgets["obj1TFBG"], "left", 205),
        (widgets["obj1TFBG"], "top", 50),
        (widgets["name2TFG"], "left", 5),
        (widgets["name2TFG"], "top", 75),
        (widgets["obj2TFBG"], "left", 205),
        (widgets["obj2TFBG"], "top", 75),
        (widgets["name3TFG"], "left", 5),
        (widgets["name3TFG"], "top", 100),
        (widgets["obj3TFBG"], "left", 205),
        (widgets["obj3TFBG"], "top", 100),
        (widgets["name4TFG"], "left", 5),
        (widgets["name4TFG"], "top", 125),
        (widgets["obj4TFBG"], "left", 205),
        (widgets["obj4TFBG"], "top", 125),
        (widgets["name5TFG"], "left", 5),
        (widgets["name5TFG"], "top", 150),
        (widgets["obj5TFBG"], "left", 205),
        (widgets["obj5TFBG"], "top", 150),
        (widgets["button"], "left", 150),
        (widgets["button"], "top", 200),
        ])
...
def gather_info(*args):
    ...
    create_follow_constraints(tgt=tgt, spaceNames=names, spaceObjs=objs)
...
def create_follow_constraints(tgt=None, spaceNames=None, spaceObjs=None):
    ...
    cmds.setAttr("{0}.follow".format(tgt), 0)
