...
def jointRadiusUI(*args):
    ...
    widgets["slider"] = cmds.floatSliderGrp(l="radius", min=0.05, max=2, field=True, fieldMinValue=0, fieldMaxValue=2, precision=2, sliderStep=0.1, value=1.0, cw=([1,40], [2,45], [3, 115]), cal=([1,"left"], [2,"left"], [3,"left"]))
