...
def fixFirstClash(clashes, shapes=0):
    """
    takes in list of base names that are clashing (ie. "pSphere1", meaning that there are multiple instances of this
     name), if there's more than one clash in the list, redo the clash detection to make sure names stay relevant
     """
