...
def rigToolsUI(*args):
	...
	widgets["win"] = cmds.window("rigToolWin", t="zbw_rigTools", w=280, h=570, s=False)
	widgets["mainCLO"] = cmds.columnLayout(w=280, h=570)
	widgets["mainFLO"] = cmds.formLayout(w=280, h=570, bgc = (0.1,0.1,0.1))
...
#zScript Layout
	cmds.setParent(widgets["mainFLO"])
	widgets["zScrptFLO"] = cmds.formLayout(w=280, h=240, bgc = (0.3,0.3,0.3))
	widgets["zScrptFrLO"] = cmds.frameLayout(l="Z_SCRIPTS", w=280, h=240, bv=True, bgc = (0.3,0.3,0.3))
