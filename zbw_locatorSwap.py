...
"""
select the simmed objects (preferably in order) and run this. Will put at loc at the pivot point, parent constain to follow it, then bake the sim and delete the constraint
"""
