...
def crvToolsUI():
    ...
    # common functions
    widgets["funcsFrLO"] = cmds.frameLayout("Common Curve Functions", w=width, cll=False, bgc = (0, 0, 0), cc=resizeWindow)
    ...
    widgets["rebuildFrLO"] = cmds.frameLayout("Rebuild Curves", w=width, cll=True, cl=False, bgc = (0, 0, 0), cc=resizeWindow)
    ...
    # hammer points
    cmds.setParent(widgets["CLO"])
    widgets["hammerFrLO"] = cmds.frameLayout("Hammer/Smooth Points", w=width, cll=True, cl=False, bgc = (0, 0, 0), cc=resizeWindow)
    ...
    # create line
    cmds.setParent(widgets["CLO"])
    widgets["lineFrLO"] = cmds.frameLayout("Create Line", w=width, cll=True, cl=False, bgc = (0, 0, 0), cc=resizeWindow)
...
def createLine(*args):
    ...
    [uniform] is whether the parameterization should be uniform (even), which makes the points not even
    """
    uniform = True
